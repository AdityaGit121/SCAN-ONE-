  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.fillColor('#ffffff').fontSize(18).font('Helvetica-Bold')
         .text('SCAN ONE — THREAT AUDIT REPORT', 55, 52);
      ...
      doc.fontSize(7.5).fillColor(textDim)
         .text('This document was automatically generated by SCAN ONE. Heuristic and AI telemetry should be validated before executing high-risk binaries.', 40, 780, { align: 'center', width: 515 });
